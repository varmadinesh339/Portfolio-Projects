...
if choice == "r" or choice == "right":
    ...
    a ="""\nYou have Reached a lake Please make a choice between swim or wait for a boat """
    choice =input(a)
    choice = choice.lower()
    if choice == "swim" or choice == "S":
        print("\nSorry the Lake was very lengthy and are dead due to exhaustion. Game Over.")
    elif choice == "wait" or choice == "w":
        print("\nYou have chossen to wait for a boat and then used it to pass the lake")
